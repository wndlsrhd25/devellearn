        ...
        <div class="card__body">
          ...
          <div class="half">
            ...
            <div class="description">
              <pre style="border:none; white-space : pre-wrap; font-size: 15px; max-width: 100%;">{{ projectDetail.content }}</pre>
            </div>
        ...
        <div class="card__footer">
          ...
          <div class="action">
            <button
              type="button"
              @click="ProjectButton()"
              v-if="this.$store.state.userStore.id != projectDetail.memberId && projectDetail.open != '모집완료'"
            >
              신청하기
            </button>
          </div>
