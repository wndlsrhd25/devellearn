            ...
            <v-item v-slot="{active, toggle}">
              <div class="normal">
                <div class="module">
                  ...
                  <div class="content">
                    <div class="category">{{ item.human }} 명 모집</div>
                    <h1 class="titlei">{{ item.projectName }}</h1>
...
import InsertProject from "./InsertProject.vue";

export default {
  name: "ProjectList",
  components: {ProjectDetail, InsertProject},
  data() {
    return {
      openDetail: false,
      projectList: [],
