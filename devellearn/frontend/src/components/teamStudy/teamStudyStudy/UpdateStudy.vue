      ...
      >
        <div class="card">
          ...
          <div class="card__body">
                ...
                <div>
                  ...
                  <div style="text-align: left">
                    <div class="gray-box">
                      <v-img
                        v-if="img2 == ''"
                        :src="'/api/images/teamstudy/' + img"
                        class="thumbnail-box"
                      />
                      <v-img v-else :src="img2" class="thumbnail-box" />
                    </div>
                    <v-flex xs8>
                      <v-file-input
                        v-model="image"
            ...
            <div class="half">
              <span class="stock">STUDY TITLE</span>
          ...
          <div class="card__footer">
            ...
            <div class="action">
              <button type="button" @click="updatestudy()">수정</button>
              <button
                type="button"
...
export default {
  ...
  methods: {
    ...
    preview_thumbnail() {
      this.img2 = URL.createObjectURL(this.image);
