<template>
  <div class="list-4cards">
    <b-container fluid="lg">
      <b-row>
        <template v-for="item in likedLectureList">
          <b-col cols="4" v-if="item.lectureNo != null" :key="item.lectureNo">
            ...
            <b-card
              ...
              "
            >
              <b-card-text>{{ item.memberId }}</b-card-text>
              <b-card-text>
                <b-icon-star-fill
