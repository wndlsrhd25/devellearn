<template>
  <div class="list-3cards">
    <b-container fluid="lg">
      <b-row>
        <template v-for="item in learningLectureList">
          <template>
            <b-col cols="4" :key="item.lectureNo"
              ><b-card
                :title="item.title"
              ...
              >
                <div>
                  ...
                  {{
                    (
                      (item.totalWatchedTime / item.totalPlayTime) *
                      100
                    ).toFixed(2)
                  }}%
                </div>
                ...
                <b-progress class="mt-2" :max="max">
                  <b-progress-bar
                    :value="(item.totalWatchedTime / item.totalPlayTime) * 100"
                    variant="success"
                  ></b-progress-bar>
                </b-progress>
              </b-card>
