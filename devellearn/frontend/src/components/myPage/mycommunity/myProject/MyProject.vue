          ...
          <template v-slot:default>
            <thead>
              <tr>
                ...
                <th style="font-size:12px; text-align: center;">참가일</th>
                <th style="font-size:12px; text-align: center;">참가여부</th>
                <th style="font-size:12px; text-align: center;">참가한 멤버ID</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="item in projectList" :key="projectList.projectconsNo">
                ...
                <td class="w2" style="font-size: 14px !important">
                ...
                <td class="w4">
                  <p>{{ item.approvalDate | yyyyMMdd }}</p>
                </td>
                <td class="w4">
                  <p>{{ item.withdraw }}</p>
                </td>
