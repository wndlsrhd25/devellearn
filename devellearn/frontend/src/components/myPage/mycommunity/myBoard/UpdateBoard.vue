    ...
    >
      <div class="card">
        ...
        <div class="card__body">
          <div class="half">
            <div class="featured_text">
              <h1 style="font-size: 30px; color: #00336d">wtih Together</h1>
              <p class="sub" style="font-size: 20px">자유 글을 작성해보세요!</p>
        ...
        <div class="card__footer">
          ...
          <div class="action">
            <button type="button" @click="updateboard()">등록</button>
            <button
              type="button"
