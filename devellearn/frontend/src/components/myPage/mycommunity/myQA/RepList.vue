          ...
          <template v-slot:default>
            <thead>
              <tr>
                ...
                <th style="font-size:12px; text-align: center;">작성한 답변내용</th>
                <th style="font-size:12px; text-align: center;">답변작성자</th>
                <th style="font-size:12px; text-align: center;">작성일</th>
                <th style="font-size:12px; text-align: center;">채택여부</th>
              </tr>
            </thead>
            <tbody>
              <tr
              ...
              >
                ...
                <td class="w1">
                  <b-button class="btn2" variant="outline-primary">
                    {{ item.choice }}
                  </b-button>
                </td>
              </tr>
