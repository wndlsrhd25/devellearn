...
<div class="card__body">
  <div class="half">
    ...
    <p class="sub" style="font-size:15px">{{ qnaDetail.category }}</p>
    <div class="recommend">
      <p>QnA by</p>
      <h3>{{ qnaDetail.memberId }}</h3>
    </div>
    </div>
    <button type="button" class="btn01" style="float : left"  @click="reportQna()"
    v-if="$store.state.userStore.id!=''">신고</button>
    <button type="button" class="btn01" style="float : right" @click="EditButton()"
    v-if="this.$store.state.userStore.id == qnaDetail.memberId">수정</button>
    <button type="button" class="btn02" style="float : right" @click="DeleteButton()"
    v-if="this.$store.state.userStore.id == qnaDetail.memberId">삭제</button>
    <br><hr>
    <div class="description">
      <pre style="border:none; white-space : pre-wrap; font-size: 15px; max-width: 100%;">{{ qnaDetail.content }}</pre>
    </div>
  </div> 
                ...
                <li>
                  <div class="commentText">
                    ...
                    <button type="button" class="btn04" style="float:right"
                      ...
                      v-if="
                        $store.state.userStore.id == qnaDetail.memberId && !isHidden
                      "
