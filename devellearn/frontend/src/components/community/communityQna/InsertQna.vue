    ...
    >
      <div class="card">
        ...
        <div class="card__body">
          <div class="half">
            <div class="featured_text">
              <h1 style="font-size: 30px; color: #00336d">wtih QnA</h1>
              <p class="sub" style="font-size: 20px">지식QnA 질문해보세요!</p>
              <p class="price" style="font-size: 20px">#DEVELLEARN</p>
            </div>
          </div>
          <div class="half">
            <span class="stock">QnA TITLE</span>
        ...
        <div class="card__footer">
          ...
          <div class="action">
            <button type="button" @click="insertqna()">등록</button>
            <button
              type="button"
