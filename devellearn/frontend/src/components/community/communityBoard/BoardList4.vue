<template class="all">
  <div>
    ...
    <insert-board4 @reload="getBoardList()" ref="insertPopup"></insert-board4>
...
import InsertBoard4 from "./InsertBoard4.vue";

export default {
  name: "BoardList4",
  components: {BoardDetail, InsertBoard4},
  data() {
    return {
      openDetail: false,
      boardList: [],
