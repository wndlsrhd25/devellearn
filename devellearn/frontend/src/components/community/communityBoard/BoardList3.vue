<template class="all">
  <div>
    ...
    <insert-board3 @reload="getBoardList()" ref="insertPopup"></insert-board3>
...
import InsertBoard3 from "./InsertBoard3.vue";

export default {
  name: "BoardList3",
  components: {BoardDetail, InsertBoard3},
  data() {
    return {
      openDetail: false,
      boardList: [],
