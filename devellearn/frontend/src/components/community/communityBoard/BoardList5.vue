<template class="all">
  <div>
    ...
    <v-item-group active-class="primary">
      <v-container class="out0">
        ...
        <div class="openline">
          ...
          <el-button @click="insertButton()" class="btn"
          v-if="this.$store.state.userStore.id == 'admin'"
          >글 등록</el-button>
        </div>
    ...
    <insert-board5 @reload="getBoardList()" ref="insertPopup"></insert-board5>
...
import InsertBoard5 from "./InsertBoard5.vue";

export default {
  name: "BoardList5",
  components: {BoardDetail, InsertBoard5},
  data() {
    return {
      openDetail: false,
      boardList: [],
