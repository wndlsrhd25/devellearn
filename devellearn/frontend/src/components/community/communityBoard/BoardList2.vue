<template class="all">
  <div>
    ...
    <insert-board2 @reload="getBoardList()" ref="insertPopup"></insert-board2>
...
import InsertBoard2 from "./InsertBoard2.vue";

export default {
  name: "BoardList2",
  components: {BoardDetail, InsertBoard2},
  data() {
    return {
      openDetail: false,
      boardList: [],
